                                            ...
                                            <div class="col-md-6">
                                                <div class="form-body">
                                                  <div class="form-group @if ($errors->has('name')) error @endif">
                                                      ...
                                                      <input type="text" id="eventRegInput1" class="form-control" placeholder="category" name="name" value="{{ old('name') }}">
                                                      @if ($errors->has('name'))
                                                  ...
                                                  <div class="form-group @if ($errors->has('sid')) error @endif">
                                                      ...
                                                      <input type="number" id="eventRegInput1" class="form-control" placeholder="sequence no" name="sid" value="{{ old('sid') }}">
                                                      @if ($errors->has('sid'))
                                                          <div class="help-block">
                                                              <ul role="alert">

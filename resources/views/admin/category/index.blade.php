            ...
            <div class="row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">List Categories
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-3 col-12">
                  <div class="btn-group float-md-right">
                    <a href="{{ route('categories.create') }}" class="btn btn-float btn-primary btn-sm waves-effect waves-light" type="button">
                                            ...
                                            <tbody>
                                              ...
                                              @foreach ($categories as $category)
                                                <tr>
                                                  ...
                                                  <td>
                                                      <a href="{{ route('categories.show', ['id' => $category->id]) }}" class="{{ ($category->status == 1) ? 'success' : 'danger' }} edit mr-1"><span class="material-icons icons-small">{{ ($category->status == 1) ? 'visibility' : 'visibility_off' }}</span></a>
                                                      <a href="{{ route('categories.edit', ['id' => $category->id]) }}" class="primary edit mr-1"><span class="material-icons icons-small">edit</span></a>
                                                      <a data-url="{{ route('category_delete', ['id' => $category->id]) }}" class="danger delete mr-1 confirm-color" href="javascript:void(0);"><span class="material-icons icons-small">delete_forever</span></a>
                                                      <!-- <span class="dropdown">

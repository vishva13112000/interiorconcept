                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form-center">Edit Color</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('pcolors.update',['id' => $pcolor->id]) }}" method="post">
                                      {{ csrf_field() }}
                                      {{ method_field('PUT') }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-body">
                                                  <div class="form-group @if ($errors->has('name')) error @endif">
                                                      ...
                                                      <input type="text" id="hue-demo" class="form-control minicolors" data-control="hue" placeholder="select color" name="name" value="{{ $pcolor->name }}">
                                                      <!-- <input type="text" id="eventRegInput1" class="form-control" placeholder="color" name="name" value="{{ $pcolor->name }}"> -->
                                                      @if ($errors->has('name'))
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="input-group">
                                                          ...
                                                          <div class="d-inline-block custom-control custom-radio">
                                                              <input value="0" type="radio" name="status" class="custom-control-input" id="no" {{ ($pcolor->status == 0) ? 'checked' : ''}}>

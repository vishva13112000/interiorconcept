            ...
            <div class="row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">List Colors
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-3 col-12">
                  <div class="btn-group float-md-right">
                    <a href="{{ route('pcolors.create') }}" class="btn btn-float btn-primary btn-sm waves-effect waves-light" type="button">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List Colors</h4>
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                              ...
                                              @foreach ($pcolors as $pcolor)
                                                <tr>
                                                  <td>{{ $nCount }}</td>
                                                  <!-- <td style="background-color:{{ $pcolor->name }}">{{ $pcolor->name }}</td> -->
                                                  <td><p style="background-color:{{ $pcolor->name }}" class="btn mr-1 mb-1 waves-effect waves-light">{{ $pcolor->name }}</p></td>
                                                  <!-- <td>{{ ($pcolor->status == 1) ? 'Active' : 'Inactive' }}</td> -->
                                                  <td>{{ $pcolor->created_at }}</td>
                                                  <td>
                                                      <a href="{{ route('pcolors.show', ['id' => $pcolor->id]) }}" class="{{ ($pcolor->status == 1) ? 'success' : 'danger' }} edit mr-1"><span class="material-icons icons-small">{{ ($pcolor->status == 1) ? 'visibility' : 'visibility_off' }}</span></a>
                                                      <a href="{{ route('pcolors.edit', ['id' => $pcolor->id]) }}" class="primary edit mr-1"><span class="material-icons icons-small">edit</span></a>
                                                      <a data-url="{{ route('pcolor_delete', ['id' => $pcolor->id]) }}" class="danger delete mr-1 confirm-color" href="javascript:void(0);"><span class="material-icons icons-small">delete_forever</span></a>

                                                      <!-- <a href="{{ route('pcolors.show', ['id' => $pcolor->id]) }}" class="{{ ($pcolor->status == 1) ? 'success' : 'danger' }} edit mr-1"><i class="la {{ ($pcolor->status == 1) ? 'la-eye' : 'la-eye-slash' }}"></i></a>
                                                      <a href="{{ route('pcolors.edit', ['id' => $pcolor->id]) }}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
                                                      <a data-url="{{ route('pcolor_delete', ['id' => $pcolor->id]) }}" class="danger delete mr-1 confirm-color" href="javascript:void(0);"><i class="la la-trash-o"></i></a> -->
                                                      <!-- <span class="dropdown">

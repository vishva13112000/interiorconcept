                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('categories.update',['id' => $category->id]) }}" method="post">
                                      {{ csrf_field() }}
                                      {{ method_field('PUT') }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-body">
                                                  <div class="form-group @if ($errors->has('name')) error @endif">
                                                      ...
                                                      <input type="text" id="eventRegInput1" class="form-control" placeholder="category" name="name" value="{{ $category->name }}">
                                                      @if ($errors->has('name'))
                                                  ...
                                                  <div class="form-group @if ($errors->has('sid')) error @endif">
                                                      <label for="eventRegInput1">Sequence No</label>
                                                      <input type="number" id="eventRegInput1" class="form-control" placeholder="sequence no" name="sid" value="{{ $category->sid }}">
                                                      @if ($errors->has('sid'))
                                                          <div class="help-block">
                                                              <ul role="alert">
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="input-group">
                                                          ...
                                                          <div class="d-inline-block custom-control custom-radio">
                                                              <input value="0" type="radio" name="status" class="custom-control-input" id="no" {{ ($category->status == 0) ? 'checked' : ''}}>

                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form-center">Edit Product</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('products.update',['id' => $product->id]) }}" method="post">
                                      {{ csrf_field() }}
                                      {{ method_field('PUT') }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-body">
                                                  <div class="form-group @if ($errors->has('category_id')) error @endif">
                                                      ...
                                                      <select name="category_id[]" class="select2-placeholder form-control" multiple id="single-placeholder">
                                                        <optgroup label="select categories">
                                                          @foreach ($categories as $category)
                                                              <option {{ (in_array($category->id,$productCategoryIds)) ? 'selected' : ''}} value="{{ $category->id }}">{{ $category->name }}</option>
                                                          @endforeach
                                                        </optgroup>
                                                      </select>
                                                  ...
                                                  <div class="form-group @if ($errors->has('name')) error @endif">
                                                      ...
                                                      <input type="text" id="eventRegInput1" class="form-control" placeholder="title" name="name" value="{{ $product->name }}">
                                                      @if ($errors->has('name'))
                                                          <div class="help-block">
                                                              <ul role="alert">
                                                  ...
                                                  <div class="form-group @if ($errors->has('description')) error @endif">
                                                      ...
                                                      <textarea id="eventInput3" rows="3" class="form-control" name="description" placeholder="description">{{ $product->description }}</textarea>
                                                  ...
                                                  <div class="form-group @if ($errors->has('size')) error @endif">
                                                      ...
                                                      <input type="text" id="eventRegInput1" class="form-control" placeholder="size" name="size" value="{{ $product->size }}">
                                                      @if ($errors->has('size'))
                                                          <div class="help-block">
                                                              <ul role="alert">
                                                  ...
                                                  <div class="form-group @if ($errors->has('color_id')) error @endif">
                                                      ...
                                                      @foreach ($pcolors as $color)
                                                            <input type="checkbox" {{ (in_array($color->id,$productColorIds)) ? 'checked' : ''}} value="{{ $color->id }}" class="form-control" name="color_id[]">
                                                            <p style="background-color:{{ $color->name }}">{{ $color->name }}</p>
                                                      @endforeach
                                                  ...
                                                  <div class="form-group @if ($errors->has('price')) error @endif">
                                                      ...
                                                      <input type="number" id="eventRegInput1" class="form-control" placeholder="price" name="price" value="{{ $product->price }}">
                                                      @if ($errors->has('price'))
                                                          <div class="help-block">
                                                              <ul role="alert">
                                                  ...
                                                  <div class="form-group @if ($errors->has('tag_id')) error @endif">
                                                      ...
                                                      <select name="tag_id[]" class="select2 form-control" multiple="multiple">
                                                        <optgroup label="select tags">
                                                           @foreach ($tags as $tag)
                                                              <option  {{ (in_array($tag->id,$productTagIds)) ? 'selected' : ''}} value="{{ $tag->id }}">{{ $tag->name }}</option>
                                                           @endforeach
                                                        </optgroup>
                                                      </select>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="input-group">
                                                          <div class="d-inline-block custom-control custom-radio mr-1">
                                                              <input value="1" type="radio" name="status" class="custom-control-input" id="yes" checked>
                                                              <label class="custom-control-label" for="yes">Active</label>
                                                          </div>
                                                          <div class="d-inline-block custom-control custom-radio">
                                                              <input value="0" type="radio" name="status" class="custom-control-input" id="no" {{ ($product->status == 0) ? 'checked' : ''}}>

                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Add Tag
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form-center">Add Tag</h4>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-body">
                                                  <div class="form-group @if ($errors->has('name')) error @endif">
                                                      ...
                                                      <input type="text" id="eventRegInput1" class="form-control" placeholder="tag" name="name" value="{{ old('name') }}">
                                                      @if ($errors->has('name'))

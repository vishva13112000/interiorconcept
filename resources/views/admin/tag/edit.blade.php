                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('tags.index') }}">Tags</a>
                                </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form-center">Edit Tag</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('tags.update',['id' => $tag->id]) }}" method="post">
                                      {{ csrf_field() }}
                                      {{ method_field('PUT') }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-body">
                                                  <div class="form-group @if ($errors->has('name')) error @endif">
                                                      ...
                                                      <input type="text" id="eventRegInput1" class="form-control" placeholder="tag" name="name" value="{{ $tag->name }}">
                                                      @if ($errors->has('name'))
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="input-group">
                                                          ...
                                                          <div class="d-inline-block custom-control custom-radio">
                                                              <input value="0" type="radio" name="status" class="custom-control-input" id="no" {{ ($tag->status == 0) ? 'checked' : ''}}>
                                        ...
                                        <div class="form-actions text-center">
                                          <a href="{{ route('tags.index') }}" class="btn btn-warning mr-1">

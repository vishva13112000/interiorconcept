            ...
            <div class="row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">List Tags
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right col-md-3 col-12">
                  <div class="btn-group float-md-right">
                    <a href="{{ route('tags.create') }}" class="btn btn-float btn-primary btn-sm waves-effect waves-light" type="button">
                                            ...
                                            <tbody>
                                              ...
                                              @foreach ($tags as $tag)
                                                <tr>
                                                  ...
                                                  <td>
                                                      <a href="{{ route('tags.show', ['id' => $tag->id]) }}" class="{{ ($tag->status == 1) ? 'success' : 'danger' }} edit mr-1"><span class="material-icons icons-small">{{ ($tag->status == 1) ? 'visibility' : 'visibility_off' }}</span></a>
                                                      <a href="{{ route('tags.edit', ['id' => $tag->id]) }}" class="primary edit mr-1"><span class="material-icons icons-small">edit</span></a>
                                                      <a data-url="{{ route('tag_delete', ['id' => $tag->id]) }}" class="danger delete mr-1 confirm-color" href="javascript:void(0);"><span class="material-icons icons-small">delete_forever</span></a>

                                                      <!-- <a href="{{ route('tags.show', ['id' => $tag->id]) }}" class="{{ ($tag->status == 1) ? 'success' : 'danger' }} edit mr-1"><i class="la {{ ($tag->status == 1) ? 'la-eye' : 'la-eye-slash' }}"></i></a>
                                                      <a href="{{ route('tags.edit', ['id' => $tag->id]) }}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
                                                      <a data-url="{{ route('tag_delete', ['id' => $tag->id]) }}" class="danger delete mr-1 confirm-color" href="javascript:void(0);"><i class="la la-trash-o"></i></a> -->
                                                      <!-- <span class="dropdown">
